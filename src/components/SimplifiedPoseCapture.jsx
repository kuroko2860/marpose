    ...
    <div className="min-h-screen bg-gray-900 text-white">
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="grid grid-cols-1 xl:grid-cols-12 gap-4 lg:gap-6">
          ...
          {/* Center Column - Video Feed (Larger) */}
            ...
            {capturedImages.length > 0 && (
              <div className="flex justify-end">
                <button
                  ...
                  className="px-3 py-2 lg:px-4 lg:py-2 bg-red-600 hover:bg-red-700 text-white rounded-lg transition-colors flex items-center space-x-2 text-sm lg:text-base"
                >
                  <svg
                    className="w-4 h-4"
                    fill="none"
                  ...
                  <span className="hidden sm:inline">Xóa tất cả ảnh</span>
